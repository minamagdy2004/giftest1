...
client.gif = {
  ...
  log: "769149945705398303", //GİF ATINCA MESAJIN GİDECEĞİ LOG KANALI İDSİ
  sunucu: "Video Ardééks Creative", //SUNUCU İSMİ /  
  rastgele: {
    PP: "769150239105351691", // BİRİSİ AVATAR DEĞİŞİNCE PP İSE PP KANALI İD
    GIF: "769150256809377871" // BİRİSİ AVATAR DEĞİŞİNCE GIF İSE GIF KANALI İD
  }
...
client.login(ayarlar.token).catch(err=> console.error('[HATA] Tokeniniz Hatalıdır. Tokeni Degiştirin Lütfen.'));
